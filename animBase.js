...
class animBase{
    constructor(characterSrc,isAnim=false,model_data){
       // const divContainer=document.querySelector('#webgl-container');
        const divContainer=model_data['viewcontainer'];
        ...
        this._scene=scene;
        console.log("animBaswe loadss!!:",isAnim,model_data);
        this._setupCamera();
        this._setupLight();
    ...
    resize(){
        ...
        this._renderer.setSize(592,592);
