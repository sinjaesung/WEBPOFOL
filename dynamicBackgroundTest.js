...
class App{
    ...
    _setupModel(){
        ...
        const cylinderRenderTaget = new THREE.WebGLCubeRenderTarget(2048,renderTargetOptions);
        const cylinderCamera= new THREE.CubeCamera(0.1,1000,cylinderRenderTaget);
        ...
        envMap: cylinderRenderTaget.texture, reflectivity:0.95});
        ...
        this._scene.traverse(obj=>{
            if(obj instanceof THREE.Object3D){
                ...
                if(mesh instanceof THREE.Mesh && cubeCamera instanceof THREE.CubeCamera){
                    mesh.visible= false;//내 자신에 내가 비칠경우 무한오류발생하여 방지하기위함.
